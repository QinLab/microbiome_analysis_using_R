...
```{r Figure-1, echo=FALSE, fig.align="center", fig.cap="R Studio in Action"}
knitr::include_graphics("figures/ch02_rstudio.png")
```
...
```{r Figure-2, echo=FALSE, fig.align="center", fig.cap="Package Installation Tab", fig.height=5, fig.width=5}
...
```{r Example R chunk, fig.width=3, fig.height=3}
...
Taken together, working with a well-developed IDE, understanding how to access packages relevant to your work and developing an efficient system for documenting and publishing your work are critical for the completion of any analysis using R. In particular, the iterative stages of data exploration and statistical testing along with plot generation can be integrated using R IDE's and packages. These iterative steps can be documented as you explore your data using R Markdown and ultimately shared with colleagues and published.
